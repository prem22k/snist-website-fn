...
function Home() {
    ...
    return (
        <div className='min-h-screen bg-gradient-to-br from-gray-900 to-indigo-950 py-12 px-4 sm:px-6 lg:px-8 text-gray-200 flex items-center justify-center'>
            {submitStatus === 'success' && <SuccessAnimation />}
            {submitStatus === 'error' && <ErrorAnimation />}

            <div className='max-w-md mx-auto bg-gray-800 rounded-xl shadow-lg overflow-hidden md:max-w-2xl border border-gray-700 mt-10'>
                <div className='p-8'>
